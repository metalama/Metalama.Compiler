...
internal sealed partial class SolutionCompilationState
{
    ...
    private sealed partial class RegularCompilationTracker : ICompilationTracker
    {
            ...
            SolutionCompilationState compilationState, CancellationToken cancellationToken)
        {
            ...
            {
                var finalState = await GetOrBuildFinalStateAsync(solution, cancellationToken: cancellationToken).ConfigureAwait(false);
                return finalState.TransformerDiagnostics;
            }
            // </Metalama>
